...
- [x] **Seção 1 — Introdução** *(1h 42min)* ✅ 2026-04-23 → [[Seção 1 - Introdução]] · 🗺️ [[Mapa - Seção 1 - Introdução.canvas|Mapa]]
  - O que faz um Engenheiro de Dados
  - Diferença DE vs DS vs DBA
- [ ] **Seção 2 — Aspectos Gerais** *(2h 52min)* → [[Seção 2 - Aspectos Gerais]] · 🗺️ [[Mapa - Seção 2 - Aspectos Gerais.canvas|Mapa]]
  - OLTP vs OLAP
